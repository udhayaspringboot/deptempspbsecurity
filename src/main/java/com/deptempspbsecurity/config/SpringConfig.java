...
package com.deptempspbsecurity.config;
...
public class SpringConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/home").permitAll().antMatchers("/").hasAnyRole("ADMIN","USER","HR").antMatchers("/homeserv").hasAnyRole("ADMIN","USER","HR").antMatchers("lisEmp").hasAnyRole("ADMIN","USER","HR").antMatchers("/hrtab").hasRole("HR").antMatchers("/**").hasRole("ADMIN")
