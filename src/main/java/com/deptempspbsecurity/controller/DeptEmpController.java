package com.deptempspbsecurity.controller;
...
import com.deptempspbsecurity.service.DeptEmpService;
import com.deptempspbsecurity.service.UserDetailss;
...
DeptEmpService deptEmpService;
	...
	public ModelAndView saveDept(@ModelAttribute("deptpage") Department dept,HttpServletRequest request, HttpServletResponse response) {
	...
	public ModelAndView home(HttpServletRequest request,HttpServletResponse response)
{
	...
	public ModelAndView listDepartment(@ModelAttribute("emppage") Employee emp,@PathParam("deptId") int deptId,HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	public ModelAndView updateEmployee(@ModelAttribute("emppage") Employee empk,@PathVariable ("empId") int empId,HttpServletRequest request, HttpServletResponse response) 
{
	...
	public ModelAndView addEmployee(@ModelAttribute("emppage") Employee emp, HttpServletRequest request, HttpServletResponse response)
 {
	...
	public ModelAndView saveEmployee(@ModelAttribute("emppage") Employee emp,HttpServletRequest request, HttpServletResponse response) {
